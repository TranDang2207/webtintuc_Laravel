                ...
                <div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
                    <div class="sticky-content-inner">
                        ...
                        <div class="page--title pd--30-0">
                            <h2 class="h2">Welcome To <span>USNews</span></h2>
                            ...
                            <ul class="nav row">
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-01.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">General Editorial</h3>
                                        </div>

                                        <div class="content">
                                            <p>Praesentium voluptatum deleniti atque  molestias excepturi sint.</p>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-02.png" alt="">
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-03.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">Press Office</h3>
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-04.png" alt="">
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-05.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">Send Us A Blog-Pitch</h3>
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-06.png" alt="">
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-07.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">Satelite / Broadcust</h3>
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-08.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">Rights &amp; Permission</h3>
                                        </div>
                                ...
                                <li class="col-md-4 col-xs-6 col-xxs-12">
                                    <a href="contact-2.html">
                                        <div class="icon">
                                            <img src="img/contact-img/icon-09.png" alt="">
                                        </div>

                                        <div class="title">
                                            <h3 class="h5">Career / Work With Us</h3>
                                        </div>
